...
class BasicListViewAdapter(val context: Context, val allStudents: MutableList<Student>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        if(convertView == null) {
            ...
            index.setText(currentStudent.index.toString())
            fullName.setText(currentStudent.name + " " + currentStudent.surname)
        }
        else{
            view = convertView
        }
